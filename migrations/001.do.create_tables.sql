CREATE TABLE users(id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, first_name VARCHAR NOT NULL, last_name VARCHAR NOT NULL, username VARCHAR NOT NULL, rating smallint);
